  ...
  return (
    <header className="mb-8 flex flex-wrap items-end justify-between gap-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <span className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-xs text-zinc-700">
          <Filter className="h-3.5 w-3.5 text-tiffany-600" />
          Campanhas contendo <strong className="text-tiffany-700">{filter}</strong>
        </span>
        <DateRangePicker
          since={period.since}
          until={period.until}
