...
const TONE_BG: Record<Tone, string> = {
  brand: 'from-tiffany-500/30 to-tiffany-500/5 border-tiffany-500/30',
  ...
  neutral: 'from-zinc-400/20 to-zinc-400/5 border-zinc-200',
};

const TONE_ICON: Record<Tone, string> = {
  brand: 'text-tiffany-600 bg-tiffany-500/10',
  ...
  neutral: 'text-zinc-700 bg-zinc-500/10',
};
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p
            className={cn(
              'mt-2 font-semibold tracking-tight tabular-nums text-zinc-900',
              size === 'lg' && 'text-3xl',
              size === 'md' && 'text-2xl',
              size === 'sm' && 'text-xl',
            )}
